        ...
        {section.points && (
          <div className="space-y-6">
            {section.points.map((point, index) => (
              <div
                key={index}
                className="flex items-center gap-5 rounded-3xl border border-white/30 bg-white/70 px-8 py-6 shadow-[0_10px_40px_rgba(214,185,140,0.08)] backdrop-blur-sm"
              >
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#D6B98C]/50 bg-[#F7F3EE]">
