        ...
        {section.points && (
          <div className="grid gap-6 md:grid-cols-2">
            {section.points.map((point, index) => (
              <div
                key={index}
                className="rounded-[28px] border border-white/30 bg-gradient-to-br from-white/40 via-[#F8F2EA]/70 to-[#EEDCC3]/50 p-8 shadow-[0_10px_40px_rgba(214,185,140,0.12)] backdrop-blur-sm"
              >
